...
import surfer.server.util.scheduled.Scheduled;
...
public class ScheduledService
{
     ...
     * @throws Exception
     */
    public static ScheduledFuture<?> schedule(Runnable runnable, long delay, TimeUnit timeUnit) throws Exception
    {
     ...
     * @throws Exception
     */
    public static ScheduledFuture<?> schedule(Runnable runnable, long delay, long period,
     ...
     * @throws Exception
     */
    public static ScheduledFuture<?> scheduleDaily(Runnable runnable, int hourOfStart,
     ...
     * @throws Exception
     */
    public static ScheduledFuture<?> scheduleWeek(Runnable runnable, int weekOfStart, int hourOfStart,
        int minuteOfStart) throws Exception
    {
